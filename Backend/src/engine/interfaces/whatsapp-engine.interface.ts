...
export interface IWhatsAppEngine {
  ...
  // Messaging - Basic
  sendTextMessage(chatId: string, text: string, mentions?: string[], options?: { quotedMessageId?: string }): Promise<MessageResult>;
  sendImageMessage(chatId: string, media: MediaInput, options?: { quotedMessageId?: string }): Promise<MessageResult>;
  sendVideoMessage(chatId: string, media: MediaInput, options?: { quotedMessageId?: string }): Promise<MessageResult>;
  sendAudioMessage(chatId: string, media: MediaInput, options?: { quotedMessageId?: string }): Promise<MessageResult>;
  sendDocumentMessage(chatId: string, media: MediaInput, options?: { quotedMessageId?: string }): Promise<MessageResult>;
