...
// Source the running version from package.json so the dashboard can read it live
// and never show a stale build-time-baked version. Read once at module load.
